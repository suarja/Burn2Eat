...
describe('UserHealthInfo', () => {
  describe('create', () => {
    it('should create user health info with generated ID', () => {
      const user = UserHealthInfo.create("male" as Sex, 75 as Kilograms, 180 as Centimeters, ["walking", "running"]);
      ...
      expect(user.getId().toString()).toMatch(/^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i);
    });

    it('should validate weight range', () => {
      expect(() => UserHealthInfo.create("male" as Sex, 25 as Kilograms, 180 as Centimeters, [])).toThrow('Weight must be between 30 and 300 kg');
      expect(() => UserHealthInfo.create("male" as Sex, 350 as Kilograms, 180 as Centimeters, [])).toThrow('Weight must be between 30 and 300 kg');
    });

    it('should validate height range', () => {
      expect(() => UserHealthInfo.create("male" as Sex, 75 as Kilograms, 100 as Centimeters, [])).toThrow('Height must be between 120 and 250 cm');
      expect(() => UserHealthInfo.create("male" as Sex, 75 as Kilograms, 300 as Centimeters, [])).toThrow('Height must be between 120 and 250 cm');
    });

    it('should accept valid boundary values', () => {
      expect(() => UserHealthInfo.create("male" as Sex, 30 as Kilograms, 120 as Centimeters, [])).not.toThrow();
      expect(() => UserHealthInfo.create("male" as Sex, 300 as Kilograms, 250 as Centimeters, [])).not.toThrow();
    });
  });
  ...
  describe('createWithId', () => {
    it('should create user health info with specific ID', () => {
      ...
      const user = UserHealthInfo.createWithId(id, "female" as Sex, 65 as Kilograms, 165 as Centimeters, ["yoga"]);
  ...
  describe('getters', () => {
    ...
    beforeEach(() => {
      ...
      user = UserHealthInfo.createWithId(userId, "male" as Sex, 80 as Kilograms, 175 as Centimeters, ["swimming", "cycling"]);
    });
    ...
    it('should return primary activity key', () => {
      ...
      const userWithoutActivities = UserHealthInfo.createWithId(userId, "male" as Sex, 80 as Kilograms, 175 as Centimeters, []);
  ...
  describe('update methods', () => {
    ...
    beforeEach(() => {
      userId = UserHealthInfoId.generate();
      user = UserHealthInfo.createWithId(userId, "male" as Sex, 75 as Kilograms, 180 as Centimeters, ["walking", "running"]);
    });
    ...
    describe('withWeight', () => {
      ...
      it('should validate weight range', () => {
        expect(() => user.withWeight(25 as Kilograms)).toThrow('Weight must be between 30 and 300 kg');
        expect(() => user.withWeight(350 as Kilograms)).toThrow('Weight must be between 30 and 300 kg');
      });
    });
    ...
    describe('withHeight', () => {
      ...
      it('should validate height range', () => {
        expect(() => user.withHeight(100 as Centimeters)).toThrow('Height must be between 120 and 250 cm');
        expect(() => user.withHeight(300 as Centimeters)).toThrow('Height must be between 120 and 250 cm');
      });
    });
    ...
    describe('withProfileData', () => {
      ...
      it('should validate weight when provided', () => {
        expect(() => user.withProfileData(undefined, 25 as Kilograms)).toThrow('Weight must be between 30 and 300 kg');
      });

      it('should validate height when provided', () => {
        expect(() => user.withProfileData(undefined, undefined, 100 as Centimeters)).toThrow('Height must be between 120 and 250 cm');
      });
    });
  });
  ...
  describe('equals', () => {
    it('should return true for users with same ID', () => {
      const id = UserHealthInfoId.generate();
      const user1 = UserHealthInfo.createWithId(id, "male" as Sex, 75 as Kilograms, 180 as Centimeters, []);
      const user2 = UserHealthInfo.createWithId(id, "female" as Sex, 60 as Kilograms, 165 as Centimeters, ["running"]);
