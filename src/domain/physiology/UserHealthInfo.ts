...
export class UserHealthInfo {
  ...
  withWeight(weight: Kilograms): UserHealthInfo {
    ...
    return new UserHealthInfo(this.id, this.sex, weight, this.height, [
      ...this.preferredActivityKeys,
    ])
  }
  ...
  withHeight(height: Centimeters): UserHealthInfo {
    ...
    return new UserHealthInfo(this.id, this.sex, this.weight, height, [
      ...this.preferredActivityKeys,
    ])
  }
  ...
  withSex(sex: Sex): UserHealthInfo {
    return new UserHealthInfo(this.id, sex, this.weight, this.height, [
      ...this.preferredActivityKeys,
    ])
  }
