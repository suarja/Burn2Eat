 ...
 * 
 * ✅ Benefits:
 * - ~200 lines removed (complex business logic moved to hooks)
 * - Testable business logic (hooks can be tested independently)
...
// Styles remain the same as original (omitted for brevity)
